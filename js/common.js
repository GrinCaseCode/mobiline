...
$('.beforeAfter').beforeAfter();
	...
	//кнопка sandwich
	$(".sandwich_desktop").click(function() {
		if ($(".menu-dropdown").is(":hidden")) {
			$(".menu-dropdown").slideDown(200);
			$(".sandwich_desktop").addClass("active");
		} else {
			$(".menu-dropdown").slideUp(200);
			$(".sandwich_desktop").removeClass("active");
		}
	});
	...
	$('.tabs li a').click(function(event) {
		...
		$(this).parent().parent().parent().find('.slider-prices').slick('setPosition');
	});
